...
import type { ParticipantIdsDataDto } from '../models/ParticipantIdsDataDto';
...
export class TournamentPhaseService {
    ...
    /**
     * Create double elimination phase for a tournament
     * @param tournamentId
     * @param requestBody
     * @returns BaseResponse
     * @throws ApiError
     */
    public tournamentPhaseControllerAddDoubleEliminationToTournament(
        tournamentId: string,
        requestBody: ParticipantIdsDataDto,
    ): CancelablePromise<BaseResponse> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/tournamentPhase/doubleElimination/{tournamentId}',
            path: {
